...
class ArticleDetails
{
    ...
    private function generateSidebarDisplay(CodecheckSubmission $codecheckData): string
    {
        ...
        $logoUrl = $baseUrl . '/' . $pluginPath . '/assets/img/codecheck_logo.svg';
    ...
    private function generateCompletedSidebarDisplay(CodecheckSubmission $codecheckData, string $logoUrl): string
    {
        ...
        $linkText = $codecheckData->getCertificateLinkText();
        ...
        <div class="item certificate" style="padding: 15px; margin: 5px 0;">
            <div style="display: flex; align-items: center; margin-bottom: 12px;">
                <img src="' . htmlspecialchars($logoUrl) . '" alt="CODECHECK" style="height: 38px; margin-right: 3px;">
                <span style=" padding: 3px 8px; border-radius: 12px; font-size: 0.8em;">
                    <strong>Authors:</strong><br>' . htmlspecialchars($codecheckerNames) . '
                </span>
            </div>
            
            <h4 style="margin: 0 0 0px 0; font-size: 0.8em; font-weight: 600;">
                Certificate
            </h4>';
