...
class CertificateIdentifier
{
     ...
     */
    public static function fromStr(string $identifier_str): CertificateIdentifier
    {
        // split Identifier String at '-'
        [$year, $number] = explode('-', $identifier_str);
     ...
     */
    public static function newUniqueIdentifier(CertificateIdentifierList $certificateIdentifierList): CertificateIdentifier
    {
